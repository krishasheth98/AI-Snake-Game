...
results_path = 'models/' + args.run_id
...
env = env1(args.x, args.y, args.visibility_range)
...
network = ACN(env.action_space.n, fc1_dims=args.neurons, fc2_dims=args.neurons)
...
#python train.py --episodes 100000 --gamma 0.995 --neurons 512 --learning-rate 1e-3 --max-steps 200 --run-id RUN_ID